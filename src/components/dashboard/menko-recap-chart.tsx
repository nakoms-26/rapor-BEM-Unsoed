...
export function MenkoRecapChart({ data }: Props) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3 sm:p-4 shadow-xs overflow-hidden">
      <div className="overflow-x-auto pb-2">
        <div className="h-72 sm:h-96 min-w-[320px] sm:min-w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart
              data={chartData}
              margin={{ top: 28, right: 12, left: -10, bottom: 20 }}
            >
